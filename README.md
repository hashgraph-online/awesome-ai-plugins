...
- [claude-council](https://github.com/hex/claude-council) - Claude Code plugin that asks Gemini, OpenAI, Grok, Perplexity, Kimi, OpenRouter models and a local ollama model the same question in parallel and lines the answers up with a synthesis of where they agree and differ.
