...
- [ken](https://github.com/rajnandan1/ken) - Thompson-mode coding discipline for Claude Code, Codex, Gemini CLI, OpenCode, pi, and any AGENTS.md-reading agent: think first, build bottom-up, brute force until measured, and rewrite a thrice-patched unit instead of patching it a fourth time.
