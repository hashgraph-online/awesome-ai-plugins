...
- [Coddy](https://github.com/coddy-project/coddy-agent) - General-purpose AI agent in one static Go binary with a ReAct loop, ACP server for editors, skills, rules, MCP, subagents, hooks, embedded web UI, and Telegram gateway; works with any OpenAI-compatible provider.
