...
- [big code analysis (BCA)](https://github.com/dekobon/big-code-analysis) - CLI tool and agent hooks that compute per-function code complexity metrics and report threshold violations back into coding agents.
