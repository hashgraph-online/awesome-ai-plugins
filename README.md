...
- [jev-align](https://github.com/sutro-sh/jev-align) - Human-in-the-loop CLI that lets coding agents configure Jev classification and scoring functions, while people label uncertain examples and explicitly approve GEPA-optimized definitions.
