...
- [Wiki](https://github.com/plasma-ai/wiki) - Indexed markdown knowledge bases with command-line tools for agents: generated indexes and frontmatter, structural lint, full-text search, and a git merge driver for parallel edits.
