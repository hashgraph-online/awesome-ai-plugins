...
- [opencode-acp](https://github.com/ranxianglei/opencode-acp) - OpenCode plugin that hands context compression to the model, using compress and decompress tools with three-tier summaries to bound context.
