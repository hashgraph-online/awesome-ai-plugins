...
- [kitbash](https://github.com/Open-Dev-Society/kitbash) - Breaks an idea into components and rules each one BORROW, KITBASH, or WRITE, checking every repo it names against the live GitHub API so invented ones never reach you; ships as a skill, plugin, and MCP server.
