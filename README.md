...
- [AXME Code](https://github.com/AxmeAI/axme-code) - Persistent project memory, architectural decisions, and machine-wide safety hooks for Cursor, GitHub Copilot, Cline, Continue, Roo Code, Windsurf, and other VS Code chat agents — auto-extracts learnings from chat sessions and blocks dangerous commands (force-push to main, rm -rf on protected paths, secret-file edits) before they run.
