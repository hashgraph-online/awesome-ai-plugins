...
- [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) - Terminal UI plugin for DeepSeek Harness with whale header, streaming thinking, double-Esc session rewind, and a live context progress bar with TPS; install with `dsh plugin --profile dsh-tui add @deepseek-harness-tui/dsh-tui`.
