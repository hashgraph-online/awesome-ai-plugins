...
- [RunAPI CLI Skill](https://github.com/runapi-ai/cli-skill) - Run AI image, video, music, audio, and LLM model API jobs from Codex, Claude Code, Gemini CLI, and other coding agents.
