...
- [WebLatexMCP](https://github.com/elias-ramzi/WebLatexMCP) - MCP server plus bundled skills for editing, compiling, and committing LaTeX in git-hosted projects like Overleaf.
