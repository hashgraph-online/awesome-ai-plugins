...
- [Jev Go](https://github.com/nandansrikrishna/jev-go) - Standalone Go CLI and MCP server for TypeSafe's Jev model, with typed single and batch evaluation, JSONL pipelines, resume support, and no Python dependency.
