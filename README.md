...
- [Lattices](https://github.com/arach/lattices) - Agentic macOS window manager that lets agents tile windows, launch tmux workspaces, search on-screen text, and switch project layers through a local daemon.
