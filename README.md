...
- [Open Second Brain](https://github.com/itechmeat/open-second-brain) - Agent memory in an Obsidian-compatible Markdown vault, shared by Claude Code, Codex, OpenCode, Hermes and other runtimes through MCP, hooks and a CLI.
