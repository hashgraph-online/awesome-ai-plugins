...
- [KSafe Skill](https://github.com/ioannisa/KSafe) - Agent skill for KSafe, the Kotlin Multiplatform encrypted key-value store (Android, iOS, macOS, JVM Desktop, web): API patterns, anti-patterns and gotchas, installable as a Claude Code plugin or a plain SKILL.md for Codex, Gemini CLI, Copilot CLI and Junie.
