...
- [CONTINUUM](https://github.com/Cyrax321/CONTINUUM) - MCP server providing semantic checkpoints, an idempotent action ledger, and tamper-evident logs for agent crash recovery.
