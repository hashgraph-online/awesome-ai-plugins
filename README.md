...
- [agent-swarm](https://github.com/desplega-ai/agent-swarm) - Operator skill that lets coding agents install, deploy, and operate agent-swarm on Docker Compose or Kubernetes.
