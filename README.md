...
- [pi-subagentura](https://github.com/lmn451/pi-subagentura) - Pi extension adding reusable multi-agent workflows and attachable child Pi sessions for supervised delegation.
