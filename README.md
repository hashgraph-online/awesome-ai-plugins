...
- [multi](https://github.com/szarkans/multi) - Runs one task through several AI models at once (Claude, Codex, OpenCode, Gemini) and reconciles their code-review findings into a single report; in the maintainer's measured eval it found 29 real bugs where the built-in `/code-review` found 14.
