...
- [dbx](https://github.com/t8y2/dbx) - Lightweight database client with a built-in MCP server exposing 90+ databases to AI coding agents, plus an AI SQL assistant.
