...
- [Miller](https://github.com/anortham/miller) - Code answers, not code dumps — pinpoint symbol search, call graphs, and impact analysis for token-conscious AI agents.
