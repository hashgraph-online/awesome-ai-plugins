...
- [Fractal](https://github.com/plasma-ai/fractal) - Hierarchical agent loops with recursive self-organization: nodes work in git worktrees, spawn and merge child nodes, and track cost and lifecycle from a central database.
