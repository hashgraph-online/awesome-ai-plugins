...
- [Ouroboros](https://github.com/Q00/ouroboros) - Specification-first development workflow for Codex that clarifies ambiguous requests, generates validated acceptance criteria, executes changes, and evaluates results through bounded evolutionary loops.
