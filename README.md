...
- [Obsidian Second Brain](https://github.com/eugeniughelbur/obsidian-second-brain) - Turns any Obsidian vault into an AI-first second brain with 47 slash commands for capture, thinking tools, research, and scheduled maintenance agents across Claude Code, Codex, Gemini CLI, OpenCode, and 4 more platforms.
