...
- [Memorix](https://github.com/AVIDS2/memorix) - Local-first cross-agent MCP memory server with searchable project memory, SQLite persistence, hooks, and shared context across coding agents.
