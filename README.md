...
- [Substack MCP](https://github.com/conorbronsdon/substack-mcp) - MCP server for reading Substack publication data, managing long-form drafts without publish or delete tools, and explicitly publishing short-form Notes.
