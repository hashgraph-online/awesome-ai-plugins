...
- [MongoDB Agent Skills](https://github.com/mongodb/agent-skills) - Official MongoDB skills and plugins that let coding agents write queries, design schemas, and use Atlas Search and Vector Search.
