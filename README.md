...
- [Draw.io MCP Server (drawio-mcp-server)](https://github.com/lgazo/drawio-mcp-server) - MCP server exposing Draw.io tools so AI agents can create, inspect, and modify diagrams, pages, and layers.
